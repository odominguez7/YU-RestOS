...
CACHED_LOCAL_RESPONSE = {
    ...
    "response": (
        ...
        "and overall sleep score. Utilize your Eight Sleep's temperature controls to set your bed at "
        "19\u00b0C for tonight. Your data shows 22% deeper sleep when cooler.\n\n"
        ...
        "using Eight Sleep's thermal alarm. Block 9-10 PM as wind-down time — your energy at 2/10 means "
